...
public class TwentyFourty extends JFrame implements ActionListener ,KeyListener
{
		...
		TwentyFourty(String s)
		{
			...
			image = new JLabel("", new ImageIcon("2048.png"), JLabel.CENTER);
		...
		public void game()
		{
			...
			for(int i=0;i<3;i++)
			{
				...
				{
					jp[i][j]=new JPanel();
					jl[i][j]=new JLabel("", new ImageIcon("0.png"), JLabel.CENTER);
		...
		public void randomPlay()
		{
			...
			g.placeAMove(p,2);
			jl[p.x][p.y].setIcon(new ImageIcon("2.png"));
			for (int i = 0; i < 3; i++) 
			{
				for (int j = 0; j < 3; j++) 
				{
	...
	public void refresh()
	{
			for(int i=0;i<3;i++)
			{
				...
				{
					g.board[i][j]=0;
					jl[i][j].setIcon(new ImageIcon("0.png"));
					playerScore =0;
				}
			}
			score.setText("SCORE - "+playerScore);
		...
		for(int i=0;i<3;i++)
			{
				for(int j=0;j<3;j++)
				{
					...
					{
						jl[i][j].setIcon(new ImageIcon("2.png"));
					}
					else if(g.board[i][j]== 4)
					{
						jl[i][j].setIcon(new ImageIcon("4.png"));
					}
					else if(g.board[i][j]== 8)
					{
						jl[i][j].setIcon(new ImageIcon("8.png"));
					}
